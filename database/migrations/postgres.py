...
MIGRATIONS: dict[int, list[str]] = {
    1: [
        ...
        "INSERT INTO settings (key, value) VALUES ('owner_bio', '') ON CONFLICT (key) DO NOTHING;",
        """
        ...
        CREATE TABLE IF NOT EXISTS chat_state (
            ...
            summary_up_to_id BIGINT NOT NULL DEFAULT 0,
            last_auto_memory_id BIGINT NOT NULL DEFAULT 0,
            updated_at TIMESTAMPTZ DEFAULT NOW()
        );
        """,
        "INSERT INTO settings (key, value) VALUES ('debounce_seconds', '8') ON CONFLICT (key) DO NOTHING;",
        "INSERT INTO settings (key, value) VALUES ('owner_pause_minutes', '15') ON CONFLICT (key) DO NOTHING;",
        "INSERT INTO settings (key, value) VALUES ('stop_word', '!стоп') ON CONFLICT (key) DO NOTHING;",
        "INSERT INTO settings (key, value) VALUES ('resume_word', '!старт') ON CONFLICT (key) DO NOTHING;",
        "INSERT INTO settings (key, value) VALUES ('toxicity_filter_enabled', '1') ON CONFLICT (key) DO NOTHING;",
        "INSERT INTO settings (key, value) VALUES ('toxicity_keywords', '') ON CONFLICT (key) DO NOTHING;",
        "INSERT INTO settings (key, value) VALUES ('auto_memory_enabled', '1') ON CONFLICT (key) DO NOTHING;",
        "INSERT INTO settings (key, value) VALUES ('auto_memory_every_n', '10') ON CONFLICT (key) DO NOTHING;",
        "INSERT INTO settings (key, value) VALUES ('summary_enabled', '1') ON CONFLICT (key) DO NOTHING;",
        "INSERT INTO settings (key, value) VALUES ('summary_threshold', '30') ON CONFLICT (key) DO NOTHING;",
        "INSERT INTO settings (key, value) VALUES ('owner_style', '') ON CONFLICT (key) DO NOTHING;",
        "INSERT INTO settings (key, value) VALUES ('owner_style_updated_at', '') ON CONFLICT (key) DO NOTHING;",
    ],
}
